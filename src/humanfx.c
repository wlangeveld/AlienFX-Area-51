...
// Zones
uint8_t AREA_POWER[] = {0x00};
size_t AREA_POWER_SIZE = sizeof(AREA_POWER);

uint8_t AREA_FRONT[] = {0x01, 0x02};
size_t AREA_FRONT_SIZE = sizeof(AREA_FRONT);

uint8_t AREA_RIGHT[] = {0x03, 0x04, 0x05};
size_t AREA_RIGHT_SIZE = sizeof(AREA_RIGHT);

uint8_t AREA_LEFT[] = {0x06, 0x07, 0x08};
size_t AREA_LEFT_SIZE = sizeof(AREA_LEFT);
